...
#  setPopulationParameterEstimationSettings(nbexploratoryiterations=1000, nbsmoothingiterations=500)
  ...
  # model_naive <- glmer(CD4 ~ log10rna + ( 1|PATIENT),family=binomial, data=data_naive)
...
#  setPopulationParameterEstimationSettings(nbexploratoryiterations=1000)
  ...
  # setPopulationParameterEstimationSettings(nbexploratoryiterations=1000, nbsmoothingiterations=500)
    ...
    setPopulationParameterInformation(p1_pop = list(initialValue = estimates_new_viral[i, 1]),
                                      ...
                                      p2_pop = list(initialValue = estimates_new_viral[i, 3]),
                                      beta1_pop = list(initialValue = estimates_new_viral[i, 4]),
                                      beta2_pop = list(initialValue = estimates_new_viral[i, 5]),
                                      beta3_pop = list(initialValue = estimates_new_viral[i, 6]),
                                      beta4_pop = list(initialValue = estimates_new_viral[i, 7]),
...
saveRDS(result_new, "Chapter3/Results/SettingI/result_new_B200.RDS")
saveRDS(result_new_viral, "Chapter3/Results/SettingI/result_new_viral_B200.RDS")
saveRDS(result_naive, "Chapter3/Results/SettingI/result_naive_B200.RDS")
saveRDS(result_empirical, "Chapter3/Results/SettingI/result_empirical_B200.RDS")

result_new <- readRDS("Chapter3/Results/SettingI/result_new_B200.RDS")
result_new_viral <- readRDS("Chapter3/Results/SettingI/result_new_viral_B200.RDS")
result_naive <- readRDS("Chapter3/Results/SettingI/result_naive_B200.RDS")
result_empirical <- readRDS("Chapter3/Results/SettingI/result_empirical_B200.RDS")
...
print(latex_table, file = "Chapter3/Results/SettingI/latex_table_B200.tex",include.rownames=FALSE,sanitize.text.function = function(x){x},hline.after = c(-1,0,7, 13))
