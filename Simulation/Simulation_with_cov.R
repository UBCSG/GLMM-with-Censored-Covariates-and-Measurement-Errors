...
num_boots = 100 # number of bootstrap iteration
...
for (i in 1:1){
  ...
  # if any SE is NA, rerun the simulation
...
saveRDS(result_new, "Simulation/SettingI/result_new_with_cov.RDS")
saveRDS(result_new_viral, "Simulation/SettingI/result_new_viral_with_cov.RDS")
saveRDS(result_naive, "Simulation/SettingI/result_naive_with_cov.RDS")
saveRDS(result_empirical, "Simulation/SettingI/result_empirical_with_cov.RDS")

result_new <- readRDS("Simulation/SettingI/result_new_with_cov.RDS")
result_new_viral <- readRDS("Simulation/SettingI/result_new_viral_with_cov.RDS")
result_naive <- readRDS("Simulation/SettingI/result_naive_with_cov.RDS")
result_empirical <- readRDS("Simulation/SettingI/result_empirical_with_cov.RDS")
...
print(latex_table, file = "Simulation/SettingI/latex_table_with_cov.tex",include.rownames=FALSE,sanitize.text.function = function(x){x},hline.after = c(-1,0,7, 14))
